...
struct DirectionalLightUBO {
    ...
    DirectionalLightUBO& SetColor(glm::vec3 rgb) { _colorAndIntensity = {rgb.r, rgb.g, rgb.b, _colorAndIntensity.a}; return *this; }
...
struct PointLightBlockGPU {
    ...
    PointLightBlockGPU& SetColor(glm::vec3 rgb) { _colorAndIntensity = {rgb.r, rgb.g, rgb.b, _colorAndIntensity.a}; return *this; }
...
struct SpotLightBlockGPU {
    ...
    SpotLightBlockGPU& SetColor(glm::vec3 rgb) { _colorAndIntensity = {rgb.r, rgb.g, rgb.b, _colorAndIntensity.a}; return *this; }
...
struct ConfigUBO {
    ...
    // Shadows
    int32_t dirShadowsEnabled = true;
